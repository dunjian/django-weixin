...
from tmkit.db.field import PythonObjectField
...
class RuntimeConfItem(models.Model):
    ...
    value = PythonObjectField(u"配置值", max_length=250, null=True, blank=True, help_text=u"最长250")
...
class RuntimeConfItemProxy(RuntimeConfItem):
    class Meta:
        verbose_name = u"运行时配置"
        verbose_name_plural = u"运行时配置管理"
        proxy = True